...
int IntelAFStateMachine::processResult(int afState, bool finalPositionReached,
                                       android::CameraMetadata &result)
{
    ...
    return mCurrentAfMode->processResult(afState, finalPositionReached, result);
}
...
int IntelAFModeOff::processResult(int afState, bool finalPositionReached,
                                  android::CameraMetadata& result)
{
    /**
...
int IntelAFModeAuto::processResult(int afState, bool finalPositionReached,
                                   android::CameraMetadata& result)
{
    LOG2("%s", __func__);
    mLensState = ANDROID_LENS_STATE_STATIONARY;
...
int IntelAFModeContinuousPicture::processResult(int afState, bool finalPositionReached,
                                                android::CameraMetadata& result)
{
    LOG2("%s", __func__);
    mLensState = ANDROID_LENS_STATE_STATIONARY;
