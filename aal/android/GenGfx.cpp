...
static gralloc_module_t *pGralloc = nullptr;
...
{
    if (nullptr == handle || nullptr == info) {
...
{
    if (nullptr == handle || nullptr == pGralloc) {
        return 0;
    }
