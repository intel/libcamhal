...
struct v4l2_streamon_info {
 __u32 total; /* Number of total enabled stream */
 __u8 enable[16]; /* Stream id need to be enabled */
 __u32 reserved[4];
};
...
#define VIDIOC_G_STREAMON_INFO _IOWR('V', 104, struct v4l2_streamon_info)
#define VIDIOC_S_STREAMON_INFO _IOWR('V', 105, struct v4l2_streamon_info)
