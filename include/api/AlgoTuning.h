...
typedef struct
{
    ...
    float strength_thres;    /*!< Defog strength: low value - stronger effect of defogging , high value - weaker effect of defogging */
    float darkness_thres;    /*!< Dark effect: low value - stronger defog in dark regions, high value - weaker defog in dark regions */
...
typedef struct
{
    ...
    uint32_t grid_density;                   /*!< LTM grid density. An abstract tuning parameter where minimum value (1) means maximum PnP and maximum value (5) means maximum IQ. */
