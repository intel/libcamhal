 ...
 *   Note: The third argument inputConfig is deprecated.
 *
 * \note
 ...
 * \endcode
 **/
int camera_device_config_streams(int camera_id, stream_config_t *stream_list, stream_t *inputConfig = NULL);
 ...
 *   int bpp = 0;
 *   int buffer_size = get_frame_size(V4L2_PIX_FMT_SGRBG8, 1920, 1080, V4L2_FIELD_ANY, &bpp);
