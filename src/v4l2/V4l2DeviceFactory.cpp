/*
 * Copyright (C) 2015-2018 Corporation.
 *
 ...
 */
V4l2SubDev* V4l2DeviceFactory::getSubDev(int cameraId, const string& devName)
{
    AutoMutex lock(sLock);
    V4l2DeviceFactory* factory = getInstance(cameraId);
    ...
    V4l2SubDev* subdev = new V4l2SubDev(devName);
