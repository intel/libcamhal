...
typedef enum icamera_metadata_tag {
    ...
    CAMERA_LENS_OPTICAL_AXIS_ANGLE,                   // float[]      | system
    CAMERA_LENS_POSITION,                             // float[]      | system
    ...
    CAMERA_TONEMAP_CURVE_BLUE =                       // float[]      | hidden
            CAMERA_TONEMAP_START,
    CAMERA_TONEMAP_CURVE_GREEN,                       // float[]      | hidden
    CAMERA_TONEMAP_CURVE_RED,                         // float[]      | hidden
