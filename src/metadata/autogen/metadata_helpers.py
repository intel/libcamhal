...
def ctype_enum(what):
  ...
  Example:
    ctype_enum('int32') == 'ICAMERA_TYPE_INT32'
    ctype_enum('int64') == 'ICAMERA_TYPE_INT64'
    ctype_enum('float') == 'ICAMERA_TYPE_FLOAT'

  Remarks:
    An enum is coerced to a byte since the rest of the camera_metadata
    code doesn't support enums directly yet.
  """
  return 'ICAMERA_TYPE_%s' %(what.upper())
