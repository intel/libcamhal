...
public:
    ...
    virtual int setGbceResults(const ia_aiq_gbce_results *gbceResults) { return OK; }
    virtual int setLtmParams(const ia_ltm_input_params *ltmInputParams,
                             const ia_ltm_drc_params *drcParams) { return OK; }
