...
public:
    ...
    virtual int onFrameAvailable(Port port, const shared_ptr<CameraBuffer> &camBuffer) = 0;
...
public:
    ...
    virtual int qbuf(Port port, const shared_ptr<CameraBuffer> &camBuffer) = 0;
    virtual int allocateMemory(Port port, const shared_ptr<CameraBuffer> &camBuffer) = 0;
...
public:
     ...
     */
    virtual int onFrameAvailable(Port port, const shared_ptr<CameraBuffer> &camBuffer);
     ...
     */
    virtual int allocateMemory(Port port, const shared_ptr<CameraBuffer> &camBuffer) { return -1; }
     ...
     */
    virtual int registerUserOutputBufs(Port port, const shared_ptr<CameraBuffer> &camBuffer) { return OK; }
    ...
    virtual int configure(const vector<ConfigMode>& configModes) { return OK; }
...
protected:
    ...
    map<Port, CameraBufVector> mInternalBuffers;
