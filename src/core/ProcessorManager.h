...
public:
    ...
    int configureProcessors(const vector<ConfigMode>& configModes, BufferProducer* producer,
...
private:
    ...
    // LITE_PROCESSING_S
    void createLiteProcessors(int inputFmt, const std::map<Port, stream_t>& inputConfigs,
