...
void GraphUtils::dumpConnections(const std::vector<IGraphConfig::PipelineConnection>& connections)
{
    ...
    for (auto& conn : connections) {
        ...
        LOGG("Format settings: enabled %d, terminalIdx %d, width %d, height %d, fourcc %s, bpl %d, bpp %d",
                    ...
                    0,
                    //psys_2600_term_idx_from_uid(conn.portFormatSettings.terminalId),
